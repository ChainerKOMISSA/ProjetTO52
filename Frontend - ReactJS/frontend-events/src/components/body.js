...
import { faMasksTheater, faMusic, faUserCheck, faUserDoctor, faStar, faChampagneGlasses, faGuitar, faBookOpen, faKitchenSet} from '@fortawesome/free-solid-svg-icons';
