...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Festivals</a>
      </li>
    </ul>
            ...
            <div class="card col-lg-12">
                ...
                <div class="card-body">
                  ...
                  @endif
                    <div class="row">
                        <div class="col-md-12">
                            <table id="listefestivals" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th>N°</th>
                                    <td>Nom du festival</td>
                                    <td>Decription</td>
                                    <td>Date de début</td>
                                    <td>Date de fin</td>
                                  ...
                                  @foreach ($festivals as $key =>$festival)
                                    <tr>
                                      ...
                                      <td class="project-actions text-right">
                                        ...
                                        <a class="btn btn-secondary btn-sm" href="{{ route('updatevent', ['idEvenement' => $festival['idEvenement']]) }}"><i class="far fa-edit"></i></a><br>
                                        <a class="btn btn-danger btn-sm" href="" onclick="if(confirm('Voulez-vous vraiment supprimer cet évènement?')){
                                          document.getElementById('form-{{$festival['idEvenement']}}').submit()}"><i class="fas fa-trash"></i></a>
                                          <form id="form-{{$festival['idEvenement']}}" action="{{route('deletevent', ['idEvenement' => $festival['idEvenement']])}}" method="POST">
                                            @csrf
