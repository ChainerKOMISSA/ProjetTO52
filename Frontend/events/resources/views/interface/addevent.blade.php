  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Ajouter un nouvel évènement</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Acceuil</a></li>
              <li class="breadcrumb-item active">Ajouter un nouvel évènement</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card col-lg-12">
                <div class="card-header text-white border-danger">
                    ...
                    <!--<div class="card-tools">
                        <a href="" class="btn btn-danger">Enregistrer un nouvel évènement</a>
                    </div>-->
                </div>
                <div class="card-body">
